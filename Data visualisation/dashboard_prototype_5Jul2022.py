...
def dynamic_env(df):
    ...
    def build_event_page(
        ...
        download_widget = pn.widgets.FileDownload(
            ...
            callback=_download_callback, button_type="primary"
        )
        ...
        show_similar_events_plots = pn.widgets.Button(name='Show similar events plots',
                                                      button_type='primary')
        ...
        @pn.depends(show_similar_events_plots)
