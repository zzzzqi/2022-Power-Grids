...
similar_events = pd.DataFrame({
    "The selected similar events data": ["event_001", "event_002", "event_003",
...
material.main.append(
    pn.Row(
        pn.Column(
            similar_events,
            pn.widgets.Select(name='Options for running different clustering Algorithm', options=['algorithm1', 'algorithm2', 'algorithm3', 'algorithm4'],
                              margin=(0, 5, 5, 10)),
