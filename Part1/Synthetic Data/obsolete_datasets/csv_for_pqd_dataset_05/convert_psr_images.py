...
def mkdir(path):
    ...
    if not folder:
        ...
        os.makedirs(path + os.sep + "training_set" + os.sep + "flickers")
        os.makedirs(path + os.sep + "training_set" + os.sep + "harmonics")
        os.makedirs(path + os.sep + "training_set" + os.sep + "interruptions")
        os.makedirs(path + os.sep + "training_set" + os.sep + "interruptions_harmonics")
        os.makedirs(path + os.sep + "training_set" + os.sep + "osc_transients")
        os.makedirs(path + os.sep + "training_set" + os.sep + "sags")
        os.makedirs(path + os.sep + "training_set" + os.sep + "sags_harmonics")
        os.makedirs(path + os.sep + "training_set" + os.sep + "swells")
        os.makedirs(path + os.sep + "training_set" + os.sep + "swells_harmonics")
        os.makedirs(path + os.sep + "training_set" + os.sep + "spikes")
        os.makedirs(path + os.sep + "validation_set")
        os.makedirs(path + os.sep + "validation_set" + os.sep + "flickers")
        os.makedirs(path + os.sep + "validation_set" + os.sep + "harmonics")
        os.makedirs(path + os.sep + "validation_set" + os.sep + "interruptions")
        os.makedirs(path + os.sep + "validation_set" + os.sep + "interruptions_harmonics")
        os.makedirs(path + os.sep + "validation_set" + os.sep + "osc_transients")
        os.makedirs(path + os.sep + "validation_set" + os.sep + "sags")
        os.makedirs(path + os.sep + "validation_set" + os.sep + "sags_harmonics")
        os.makedirs(path + os.sep + "validation_set" + os.sep + "swells")
        os.makedirs(path + os.sep + "validation_set" + os.sep + "swells_harmonics")
        os.makedirs(path + os.sep + "validation_set" + os.sep + "spikes")
        os.makedirs(path + os.sep + "testing_set")
        os.makedirs(path + os.sep + "testing_set" + os.sep + "flickers")
        os.makedirs(path + os.sep + "testing_set" + os.sep + "harmonics")
        os.makedirs(path + os.sep + "testing_set" + os.sep + "interruptions")
        os.makedirs(path + os.sep + "testing_set" + os.sep + "interruptions_harmonics")
        os.makedirs(path + os.sep + "testing_set" + os.sep + "osc_transients")
        os.makedirs(path + os.sep + "testing_set" + os.sep + "sags")
        os.makedirs(path + os.sep + "testing_set" + os.sep + "sags_harmonics")
        os.makedirs(path + os.sep + "testing_set" + os.sep + "swells")
        os.makedirs(path + os.sep + "testing_set" + os.sep + "swells_harmonics")
        os.makedirs(path + os.sep + "testing_set" + os.sep + "spikes")
