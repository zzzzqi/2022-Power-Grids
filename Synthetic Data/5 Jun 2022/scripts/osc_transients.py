...
for i in range(NUMBER_OF_SAMPLES):
    ...
    transient_alpha = random.choice(range(10, 80, 1)) / 100
    transient_duration_in_cycles = random.uniform(0.5, 3)
    transient_duration_in_ms = random.uniform(8, 40)
    transient_frequency = random.uniform(300, 900)
    ...
    file_rows[4][3] = "transient alpha"
    file_rows[5][3] = "transient duration in cycles"
    file_rows[6][3] = "transient duration in ms"
    file_rows[7][3] = "transient frequency"
    file_rows[0][4] = "values"
    file_rows[1][4] = WAVE_FREQ
    file_rows[2][4] = SIGNAL_DURATION_IN_SEC * 1000
    file_rows[3][4] = SAMPLES_PER_CYCLE
    file_rows[4][4] = transient_alpha
    file_rows[5][4] = transient_duration_in_cycles
    file_rows[6][4] = transient_duration_in_ms
    file_rows[7][4] = transient_frequency
    # Edit the CSV file: 
