...
for i in range(NUMBER_OF_SAMPLES):
    ...
    a3_parameter = (random.choice(range(5, 15, 1))) / 100
    a5_parameter = (random.choice(range(5, 15, 1))) / 100
    a1_parameter = (1 - a3_parameter ** 2 - a5_parameter ** 2) ** 0.5
    # Define the sag parameters:
    sag_duration_in_cycles = random.uniform(0.5, WAVE_FREQ)
    sag_magnitude = (random.choice(range(10, 90, 5))) / 100
    # Modify the output filename: 
    output_filename = "sags_harmonics_sample0" + str(i) + ".csv"
    ...
    file_rows[4][3] = "sag duration in cycles"
    file_rows[5][3] = "sag magnitude"
    file_rows[6][3] = "a1 parameter"
    file_rows[7][3] = "a3 parameter"
    file_rows[8][3] = "a5 parameter"
    file_rows[0][4] = "values"
    file_rows[1][4] = WAVE_FREQ
    file_rows[2][4] = SIGNAL_DURATION_IN_SEC * 1000
    file_rows[3][4] = SAMPLES_PER_CYCLE
    file_rows[4][4] = sag_duration_in_cycles
    file_rows[5][4] = sag_magnitude
    file_rows[6][4] = a1_parameter
    file_rows[7][4] = a3_parameter
    file_rows[8][4] = a5_parameter
    # Edit the CSV file: 
