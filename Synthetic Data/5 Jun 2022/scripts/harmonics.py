...
for i in range(NUMBER_OF_SAMPLES):
    ...
    file_rows[4][3] = "a1 parameter"
    file_rows[5][3] = "a3 parameter"
    file_rows[6][3] = "a5 parameter"
    file_rows[0][4] = "values"
    file_rows[1][4] = WAVE_FREQ
    file_rows[2][4] = SIGNAL_DURATION_IN_SEC * 1000
    file_rows[3][4] = SAMPLES_PER_CYCLE
    file_rows[4][4] = a1_parameter
    file_rows[5][4] = a3_parameter
    file_rows[6][4] = a5_parameter
    # Edit the CSV file: 
