...
# Define the function to generate swells and harmonics
def generate_signals(n):
    for i in range(n):
        ...
        swell_duration_in_cycles = random.choice(range(1, 10, 3))
        swell_magnitude = (random.choice(range(110, 190, 10))) / 100
        # Modify the output filename: 
        output_filename = "swells_harmonics_sample0" + str(i) + ".csv"
        ...
        file_rows[5][3] = "swell duration in cycles"
        file_rows[6][3] = "swell magnitude"
        ...
        file_rows[5][4] = swell_duration_in_cycles
        file_rows[6][4] = swell_magnitude
