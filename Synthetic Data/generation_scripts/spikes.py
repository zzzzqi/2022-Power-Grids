...
# Define the function to generate spikes
def generate_signals(n):
    for i in range(n):
        # Define the spike parameters: 
        spike_magnitude = random.choice(range(10, 50, 10)) / 100
        spike_duration_in_cycles = random.choice(range(5, 55, 15)) / 100
        ...
        file_rows[5][3] = "spike magnitude"
        file_rows[6][3] = "spike duration in cycles"
        ...
        file_rows[5][4] = spike_magnitude
        file_rows[6][4] = spike_duration_in_cycles
        # Edit the CSV file: 
