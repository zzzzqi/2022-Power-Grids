...
class BASIC_CNN(object):
    ...
    def fit(self, model_name):
        ...
        BASIC_CNN.cnn.fit(self.train_dataset, validation_data=self.validation_dataset, epochs=10)
        BASIC_CNN.cnn.save_weights(saved_path)
    ...
    def predict(self, model_name):
        ...
        BASIC_CNN.cnn.load_weights(model_path)
        ...
        for each_item in prediction_set:
            ...
            predictions_res = BASIC_CNN.cnn.predict(img)
    ...
    #     plt.plot(BASIC_CNN.cnn.history['accuracy'])
    #     plt.plot(BASIC_CNN.cnn.history['val_accuracy'])
    #     plt.title('PQD CNN test04 dataset05 - accuracy levels')
    #     plt.ylabel('Accuracy (%)')
