...
class UPDOWN_CNN(object):
    ...
    def fit(self, model_name):
        ...
        UPDOWN_CNN.cnn.fit(self.train_dataset, validation_data=self.validation_dataset, epochs=10)
        UPDOWN_CNN.cnn.save_weights(saved_path)

    # show probabilities of 10 classes
    def predict(self, model_name):
        model_path = "./ckpt/" + model_name + ".h5"
        UPDOWN_CNN.cnn.load_weights(model_path)
        ...
        for each_item in prediction_set:
            ...
            predictions_res = UPDOWN_CNN.cnn.predict(img)
