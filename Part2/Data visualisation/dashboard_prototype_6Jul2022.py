...
def dynamic_env(df):
    ...
    def build_event_page(
        ...
        file_name_input_widgets = pn.widgets.TextInput(placeholder='filename.csv', width=200)
        group_name_widgets = pn.widgets.TextInput(placeholder='groupname', width=200)
            ...
            pn.Column(
                ...
                pn.WidgetBox(
                    ...
                    pn.Row(
                        pn.pane.Markdown(
                            f"""
                            - A total of {str(len(similar_events_df.index))} similar events are identified. <br>
                            - To display the selected events from the summary below:
                            """,
                            width=370
                        ),
                        pn.Column(
                    ...
                    pn.Column(
                        pn.Row(
                            pn.pane.Markdown(
                                "- To enter a designated group name for the selected events:",
                                width=370
                            ),
                            group_name_widgets
                        ),
                        pn.Row(
                            pn.pane.Markdown(
                                "- To enter the filename for the export data file:",
                                width=370
                            ),
